...
import { CalculateOperationDto, ICalculateResult } from "../models/calculate-result"
...
export class CalculateResultService {
    ...
    //calculate(operationDto: CalculateOperationDto, calculateResult: ICalculateResult) {
    //    this.http
    //        .post<ICalculateResult>(this.baseUrl + 'api/Calculate', operationDto)
    //        .subscribe(x => {
    //            calculateResult = x;
    //        });
    //}
